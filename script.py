...
async def on_message(message):
    ...
    if message.channel.id == int(channel_id) : # Remplacez CHANNEL_ID par l'ID du channel sur lequel vous souhaitez que le bot fonctionne
...
client.run(bot_token) # Remplacez BOT_TOKEN par le jeton de votre bot Discord